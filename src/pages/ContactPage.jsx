      ...
      <div className="w-full max-w-5xl mx-auto px-4">
        ...
        >
          <div className="grid lg:grid-cols-5">
            ...
            <div className="lg:col-span-2 bg-white dark:bg-muted/10 p-6 relative overflow-hidden border-b lg:border-b-0 lg:border-r border-border">
              {/* Decorative circles */}
              <div className="absolute -bottom-16 -right-16 w-32 h-32 rounded-full bg-emerald-500/5" />
              <div className="absolute -bottom-8 -right-8 w-16 h-16 rounded-full bg-emerald-500/10" />
                  ...
                  <div className="flex gap-2">
                    {socialLinks.map((social, index) => (
                      <a
                        key={index}
                        href={social.href}
                        className={`w-8 h-8 rounded-full bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 flex items-center justify-center transition-all duration-300 ${social.color}`}
                      >
                        <social.icon size={14} />
                      </a>
                    ))}
            ...
            <div className="lg:col-span-3 p-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                ...
                <Button
                  ...
                  className="w-full py-5 rounded-lg font-semibold bg-linear-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white transition-all duration-300"
                >
                  {isSubmitting ? (
                    <motion.div
                      animate={{ rotate: 360 }}
